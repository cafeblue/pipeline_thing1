...
my  $TABIX           = 'tabix/0.2.6';
my  $PERL            = 'perl/5.18.2';
my  $VCFTOOLS        = 'vcftools/0.1.12a';
my  $BEDTOOLS        = 'bedtools/2.17.0';
my  $RSCRIPT         = 'R/3.1.0';
...
our %gene_panel_text      = ('exome.gp10' => '/hpf/largeprojects/pray/llau/gene_panels/EXOMES_20140723/refSeqLongest_ICCG_20140922.isoforms.txt',
                             ...
                             'hl.gp22' => '/hpf/largeprojects/pray/llau/gene_panels/HL_20160504/HL_20160504.txt',
...
our %panelExon10bpPadFull    = ('exome.gp10' => '/hpf/largeprojects/pray/llau/gene_panels/EXOMES_20140723/refSeqLongest_exICCG_CR.ICCG_include_nonCRtargets.exons_10bp_padding.sort.merged.bed',
                             ...
                             'hl.gp22' => '/hpf/largeprojects/pray/llau/gene_panels/HL_20160504/HL_20160504.exon_10bp_padding.bed',
...
our %panelExon10bpPadBedFile  = ('exome.gp10' => 'refSeqLongest_exICCG_CR.ICCG_include_nonCRtargets.exons_10bp_padding.sort.merged.bed',
                             ...
                             'hl.gp22' => 'HL_20160504.exon_10bp_padding.bed',
...
our %panelBedFileFull         = ('exome.gp10' => '/hpf/largeprojects/pray/llau/programs/annovar/current/annovar/humandb/EXOMES_concate_gp_disease_association.bed',
                             ...
                             'hl.gp22' => '/hpf/largeprojects/pray/llau/programs/annovar/2014jul14/annovar/humandb/HL_20160504.panel.bed',
...
sub annovar {
    ...
    my $cmd = 'echo \''
        ...
        . "$runfolder/annovar/$sampleID.$postprocID.gatk.snp.indel.annovar /hpf/largeprojects/pray/llau/programs/annovar/current/annovar/humandb && \\\n"
        . "\\\n"
        . "$ANNOVAR --regionanno --colsWanted 4 -buildver hg19_disease_associations -dbtype bed --bedfile $panelBedFile{$genePanel} \\\n" 
        . "$runfolder/annovar/$sampleID.$postprocID.gatk.snp.indel.annovar /hpf/largeprojects/pray/llau/programs/annovar/current/annovar/humandb && \\\n"
        . "\\\n"
